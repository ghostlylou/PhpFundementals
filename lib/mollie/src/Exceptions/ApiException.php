...
class ApiException extends \Exception
{
     ...
     */
    public function __construct($message = "", $code = 0, $field = null, \_PhpScoperd8ff184be637\Psr\Http\Message\RequestInterface $request = null, \_PhpScoperd8ff184be637\Psr\Http\Message\ResponseInterface $response = null, $previous = null)
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public static function createFromResponse(\_PhpScoperd8ff184be637\Psr\Http\Message\ResponseInterface $response, \_PhpScoperd8ff184be637\Psr\Http\Message\RequestInterface $request = null, $previous = null)
    {
