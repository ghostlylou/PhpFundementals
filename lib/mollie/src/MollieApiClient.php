...
use _PhpScoperd8ff184be637\Composer\CaBundle\CaBundle;
use _PhpScoperd8ff184be637\GuzzleHttp\Client;
use _PhpScoperd8ff184be637\GuzzleHttp\ClientInterface;
use _PhpScoperd8ff184be637\GuzzleHttp\Exception\GuzzleException;
use _PhpScoperd8ff184be637\GuzzleHttp\HandlerStack;
use _PhpScoperd8ff184be637\GuzzleHttp\Psr7\Request;
use _PhpScoperd8ff184be637\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoperd8ff184be637\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient;
        if (!$this->httpClient) {
            $retryMiddlewareFactory = new \Mollie\Api\Guzzle\RetryMiddlewareFactory();
            $handlerStack = \_PhpScoperd8ff184be637\GuzzleHttp\HandlerStack::create();
            $handlerStack->push($retryMiddlewareFactory->retry());
            $this->httpClient = new \_PhpScoperd8ff184be637\GuzzleHttp\Client([\_PhpScoperd8ff184be637\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoperd8ff184be637\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoperd8ff184be637\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT, \_PhpScoperd8ff184be637\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::CONNECT_TIMEOUT, 'handler' => $handlerStack]);
        }
        ...
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoperd8ff184be637\GuzzleHttp\ClientInterface::MAJOR_VERSION);
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoperd8ff184be637\GuzzleHttp\ClientInterface::VERSION);
        }
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoperd8ff184be637\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoperd8ff184be637\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoperd8ff184be637\Psr\Http\Message\ResponseInterface $response)
    {
