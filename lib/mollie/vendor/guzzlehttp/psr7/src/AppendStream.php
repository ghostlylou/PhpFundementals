 ...
 */
class AppendStream implements \_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \_PhpScoperd8ff184be637\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
