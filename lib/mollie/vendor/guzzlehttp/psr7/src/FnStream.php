 ...
 */
class FnStream implements \_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
