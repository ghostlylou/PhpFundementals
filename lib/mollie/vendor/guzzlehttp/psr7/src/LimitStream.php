 ...
 */
class LimitStream implements \_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
