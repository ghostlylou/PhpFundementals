...
trait MessageTrait
{
    ...
    {
        if (!$this->stream) {
            $this->stream = \_PhpScoperd8ff184be637\GuzzleHttp\Psr7\Utils::streamFor('');
        }
        return $this->stream;
    }
    public function withBody(\_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface $body)
    {
        if ($body === $this->stream) {
            return $this;
        }
