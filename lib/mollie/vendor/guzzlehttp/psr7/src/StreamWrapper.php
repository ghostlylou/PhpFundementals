...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoperd8ff184be637\Psr\Http\Message\StreamInterface $stream)
    {
